        ...
        for i, feat in enumerate(args.s_id):
            ...
            if args.gamma == 0.0:
                ...
                if getattr(args, 'projector_type', 'matrix') == 'MLP':
                    ...
                    projector_ = torch.nn.Linear(feature_dim_student, feature_dim_teacher, bias=False).to(device)
                    projector = torch.nn.utils.parametrizations.orthogonal(projector_)
