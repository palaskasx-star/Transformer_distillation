    ...
    for samples, targets in metric_logger.log_every(data_loader, print_freq, header):
        ...
        with torch.cuda.amp.autocast():
            ...
            if epoch > 1:
              ...
              loss = ((1 - args.distillation_alpha)*loss_base + args.distillation_alpha*loss_dist) + 0.0*(0.0*loss_mf_cls + args.KoLeoData*loss_KoLeo_cls_data + args.KoLeoPrototypes*loss_KoLeo_cls_proto) + args.gamma*(loss_mf_patch)  +  args.delta*(loss_mf_rand + args.KoLeoData*loss_KoLeo_rand_data + args.KoLeoPrototypes*loss_KoLeo_rand_proto)
