...
def train_one_epoch(model: torch.nn.Module, criterion: DistillationLoss,
    ...
    for samples, targets in metric_logger.log_every(data_loader, print_freq, header):
        ...
        with torch.cuda.amp.autocast():
            ...
            base_loss, distillation_loss, review_loss = criterion(samples, outputs, targets)
            loss = ((1 - args.distillation_alpha)*loss_base + args.distillation_alpha*loss_dist) + args.distillation_beta*review_loss
        ...
        metric_logger.update(review_loss=review_loss.item())
    ...
    if writer is not None:
        ...
        writer.add_scalar('Train/Loss/mf_loss_cls', metric_logger.review_loss.global_avg, epoch)
...
def evaluate(data_loader, model, device, criterion_dist: DistillationLoss, writer=None, epoch=0):
    ...
    if writer is not None:
        ...
        writer.add_scalar('Test/Loss/review_loss', metric_logger.review_loss.global_avg, epoch)
